package com.altes.alphacure.medicalrecord.security;
 ...
 *  1. Le JWT vérifié (source de vérité principale)
 *  2. L'en-tête X-Clinic-Id injecté par le Gateway après vérification JWT
 *     (ce header a été nettoyé des requêtes entrantes par le Gateway filter)
 *
 * IMPORTANT : Le header X-Clinic-Id n'est jamais accepté depuis l'extérieur —
 * il est uniquement injecté par le ClinicContextGatewayFilter après validation JWT.
 */
@Component
